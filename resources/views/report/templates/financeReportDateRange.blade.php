...
<h2>📊 Finance Report – {{ $startDate }} to {{ $endDate }}</h2>
...
<div class="summary">
    ...
    <p><strong>Total Profit:</strong> Rs. {{ number_format($totalProfit, 2) }} (Selected date range)</p>
...
<table>
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="6">No new orders in selected date range.</td>
        </tr>
        @endforelse
    </tbody>
</table>
...
<table>
    ...
    <tbody>
        ...
        @empty
        <tr>
            <td colspan="6">No payments found in selected date range.</td>
        </tr>
        @endforelse
    </tbody>
</table>
